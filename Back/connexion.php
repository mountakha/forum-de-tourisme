...
if(isset($_SESSION['connected']) && $_SESSION['connected'] == "true") { echo"<script> document.location.href=\"index\"</script>"; }
...
$content = "Sign in to Planned Odyssey!";
$header->display("Sign in to Planned Osyssey", $_SESSION, $content);
?>
